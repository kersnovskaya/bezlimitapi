...
TEST_PHONE_IVAN = 9682221451
TEST_PHONE_JOHN = 9682223481
...
# Токен здесь генерируется каждый раз после удаления\создания аккаунта в ЛК по сценарию
# "tests/user_auth/test_registration_and_delete_case"
