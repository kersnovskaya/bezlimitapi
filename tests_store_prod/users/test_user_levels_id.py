...
class TestNegative:
    def test_unauthorized(self):
        url = 'https://api.store.bezlimit.ru/v2/users/levels/1'
    ...
    def test_incorrect_id(self):
        url = 'https://api.store.bezlimit.ru/v2/users/levels/1488'
...
class TestPositive:
    def test_correct_fields(self):
        url = 'https://api.store.bezlimit.ru/v2/users/levels/146050'
