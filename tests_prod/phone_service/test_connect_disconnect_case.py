...
class TestCommonService:
    ...
    def test_service_disconnect(self):
        ...
        assert response.json()['connectionTask'] is None, 'Отключение услуги. Параметр "connectionTask" не пустой'
...
class TestDeferredService:
    ...
    def test_service_connect(self):
        ...
        assert type(response.json()['connectionTask']) == dict, \
            'Подключение услуги. Не указана задача на отложенное подключение услуги.'
        assert type(response.json()['disconnectionTask']) == dict, \
            'Подключение услуги. Не указана задача на отложенное отключение услуги.'
    ...
    def test_service_disconnect(self):
        ...
        assert response.json()['connectionTask'] is None, \
            'Отключение услуги. Параметр "connectionTask" не пустой'
        assert response.json()['disconnectionTask'] is None, \
            'Отключение услуги. Параметр "disconnectionTask" не пустой'
